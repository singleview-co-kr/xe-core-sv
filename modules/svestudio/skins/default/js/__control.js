...
function resizeIframe( oIframe )
{
	...
	{
		//newheight = document.getElementById( oIframe ).contentWindow.document.body.scrollHeight;
		newheight = document.getElementById( oIframe ).contentWindow.document.body.offsetHeight + 300;
		newwidth = document.getElementById( oIframe ).contentWindow.document.body.scrollWidth;
	}

	document.getElementById( oIframe ).height = (newheight) + 'px';
	document.getElementById( oIframe ).width = (newwidth) + 'px';
}

function changeIframeUrl( oIframe, sUrl )
{
	document.getElementById( oIframe ).src = sUrl;
}