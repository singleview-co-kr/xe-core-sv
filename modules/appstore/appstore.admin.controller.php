...
class appstoreAdminController extends appstore
{
	 ...
	 * @brief mid 생성하거나 변경
	 **/
	public function procAppstoreAdminInsertModInst()
	{
		$oArgs = Context::getRequestVars();
		$oArgs->module = 'appstore';
		...
		$sReturnUrl = getNotEncodedUrl('', 'module', Context::get('module'), 'act', 'dispAppstoreAdminInsertModInst','module_srl',$nModuleSrl);
...
/* End of file appstore.admin.controller.php */
/* Location: ./modules/appstore/appstore.admin.controller.php */
